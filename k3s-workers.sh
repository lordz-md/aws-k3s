...
curl -sfL https://get.k3s.io | INSTALL_K3S_VERSION=v1.34.4+k3s1 K3S_TOKEN=Ex4mpL3T0k3N K3S_URL=https://"$master_ip":6443 sh -s - agent --node-ip "$local_ip" --kubelet-arg="provider-id=aws:///$provider_id"
